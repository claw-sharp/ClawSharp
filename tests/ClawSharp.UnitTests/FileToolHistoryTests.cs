// TS origin: ./utils/fileHistory.ts, ./utils/sessionStorage.ts, ./services/mcp/vscodeSdkMcp.ts, ./tools/FileEditTool/FileEditTool.ts, ./tools/FileWriteTool/FileWriteTool.ts
