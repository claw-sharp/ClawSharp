// TS origin: ./utils/debug.ts, ./utils/startupProfiler.ts, ./utils/telemetry/events.ts, ./utils/telemetry/perfettoTracing.ts, ./utils/telemetry/sessionTracing.ts, ./services/analytics/index.ts, ./services/analytics/sink.ts
