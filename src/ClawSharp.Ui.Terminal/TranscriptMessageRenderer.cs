// TS origin: ./components/messages/UserTextMessage.tsx, ./components/messages/AssistantTextMessage.tsx, ./components/messages/SystemTextMessage.tsx, ./components/messages/AttachmentMessage.tsx, ./components/Messages.js
