// TS origin: ./tools.ts, ./Tool.ts, ./utils/permissions/permissions.ts
...
public sealed class ToolRegistry
{
        ...
        IReadOnlySet<string>? allowedToolNames = null)
    {
        ...
        ToolPermissionContext = toolPermissionContext ?? ToolPermissionContexts.CreateEmpty();
    ...
    public ToolPermissionContext ToolPermissionContext { get; }
